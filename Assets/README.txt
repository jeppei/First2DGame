Adter cloning and opening the project, it might seem like the game objects are missing. This is because a new scene is shown in the Hierarchy. 
...
folder scenes you can find all the scenes. Open the first one and you will find the level with the player, terrain etc.

https://forum.unity.com/threads/game-objects-missing-from-hierarchy-pane.23289/

This project was created with this tutorial https://youtube.com/playlist?list=PLrnPJCHvNZuCVTz6lvhR81nnaf1a-b67U
